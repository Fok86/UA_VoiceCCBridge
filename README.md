...
- 🔊 Синтез мови українською (4 голоси: Микита, Лада, Тетяна, Даринка 🧒)
...
| Голос | Тип | CPU навантаження |
|-------|-----|-----------------|
| 👨 Микита | чоловічий | звичайне |
| 👩 Лада | жіночий | звичайне |
| 👩 Тетяна | жіночий | звичайне |
| 🧒 Даринка | дитячий/підлітковий | **менше фрізів** |

> Даринка використовує легшу модель — менше навантаження на CPU під час гри.
...
### Синтез мови
- **Голос** — Микита / Лада / Тетяна / Даринка
- **Швидкість** — швидкість читання
- **Живість голосу** — варіативність інтонації (0-100)
- **Дихання** — природність переходів між звуками (0-100)
